...
export async function GET() {
  try {
    ...
    console.error('[GET /webwow/api/asset-folders] Error:', error);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[POST /webwow/api/asset-folders] Error:', error);
