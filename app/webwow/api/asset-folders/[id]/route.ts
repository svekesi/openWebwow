...
/**
 * GET /webwow/api/asset-folders/[id]
 *
...
export async function GET(
  ...
  try {
    ...
    console.error('[GET /webwow/api/asset-folders/[id]] Error:', error);
...
/**
 * PUT /webwow/api/asset-folders/[id]
 *
...
export async function PUT(
  ...
  try {
    ...
    console.error('[PUT /webwow/api/asset-folders/[id]] Error:', error);
...
/**
 * DELETE /webwow/api/asset-folders/[id]
 *
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /webwow/api/asset-folders/[id]] Error:', error);
