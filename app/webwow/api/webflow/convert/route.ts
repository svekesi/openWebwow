...
/**
 * POST /webwow/api/webflow/convert
 *
 * Converts a Webflow export payload into a downloadable `.webwow` file.
 * The resulting file can be imported via `/webwow/api/project/import`.
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[POST /webwow/api/webflow/convert] Error:', error);
    return NextResponse.json(
