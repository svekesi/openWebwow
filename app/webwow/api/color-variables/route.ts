...
/**
 * GET /webwow/api/color-variables
 */
export async function GET() {
  try {
    ...
    console.error('[GET /webwow/api/color-variables] Error:', error);
...
/**
 * POST /webwow/api/color-variables
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[POST /webwow/api/color-variables] Error:', error);
