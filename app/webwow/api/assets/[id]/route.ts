...
export async function PUT(
  ...
  try {
    ...
    console.error('[PUT /webwow/api/assets/[id]] Error:', error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /webwow/api/assets/[id]] Error:', error);
