...
export async function GET(
  ...
  try {
    ...
    console.error('[GET /webwow/api/folders/[id]] Error:', error);
...
export async function PUT(
  ...
  try {
    ...
    console.error('[PUT /webwow/api/folders/[id]] Error:', error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[DELETE /webwow/api/folders/[id]] Error:', error);
