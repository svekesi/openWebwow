...
const INTEGRATIONS_ITEMS = [
  { id: 'apps', label: 'Apps', path: '/webwow/integrations/apps' },
  { id: 'webhooks', label: 'Webhooks', path: '/webwow/integrations/webhooks' },
  { id: 'api', label: 'API', path: '/webwow/integrations/api' },
  { id: 'mcp', label: 'MCP', path: '/webwow/integrations/mcp' },
];
