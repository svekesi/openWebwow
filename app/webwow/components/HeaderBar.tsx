...
export default function HeaderBar({
  ...
  const previewUrl = useMemo(() => {
    ...
    if (currentPage.error_page !== null) {
      return `/webwow/preview/error-pages/${currentPage.error_page}`;
    }
    ...
    return `/webwow/preview${path === '/' ? '' : path}`;
      ...
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start">
            <DropdownMenuItem
              onClick={() => router.push('/webwow/settings/general')}
            >
              Settings
            </DropdownMenuItem>
            ...
            <DropdownMenuItem
              onClick={() => router.push('/webwow/integrations/apps')}
            >
              Integrations
            </DropdownMenuItem>
            ...
            <DropdownMenuItem
              onClick={() => router.push('/webwow/profile')}
            >
              My profile
            </DropdownMenuItem>
      ...
      <div className="flex gap-1.5 items-center justify-center">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            {!pathname?.startsWith('/webwow/localization') && (
              <>
                <DropdownMenuSeparator />
                <DropdownMenuItem
                  onClick={() => router.push('/webwow/localization')}
                >
                  Manage locales
                </DropdownMenuItem>
              </>
        ...
        {hasUpdate && (
          <>
            ...
            <Button
              ...
              onClick={() => router.push('/webwow/settings/updates')}
            >
              Update available
            </Button>
          </>
