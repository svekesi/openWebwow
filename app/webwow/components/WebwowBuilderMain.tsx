 ...
 * - /webwow (base route)
 * - /webwow/pages/[id]/edit (page settings)
 * - /webwow/pages/[id]/layers (page layers)
 * - /webwow/collections/[id] (collections)
...
interface WebwowBuilderProps {
  children?: React.ReactNode;
}

export default function WebwowBuilder({ children }: WebwowBuilderProps = {} as WebwowBuilderProps) {
        ...
        <div className="w-full max-w-sm animate-in fade-in slide-in-from-bottom-1 duration-700" style={{ animationFillMode: 'both' }}>
          ...
          <div className="mt-4 text-center">
            <p className="text-xs text-white/50">
              First time here?{' '}
              <Link href="/webwow/welcome" className="text-white/80">
                Complete setup
              </Link>
            </p>
          </div>
